...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TipoFormularioAnalise',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, verbose_name='Tipo de formulário de análise')),
            ],
            options={
                'verbose_name': 'Tipo de Formulário de Análise',
                'verbose_name_plural': 'Tipos de Formulário de Análise',
            },
        ),
        migrations.CreateModel(
            name='TurnoTrabalho',
        ...
        migrations.CreateModel(
            name='FormularioAnaliseProcesso',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('etapa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.etapadesenvolvimento', verbose_name='Etapa de desenvolvimento')),
                ('jogo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.jogo', verbose_name='Jogo')),
                ('tipoFormulario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tipoformularioanalise', verbose_name='Tipo de formulário')),
            ],
            options={
                'verbose_name': 'Formulário de Análise do Processo',
                'verbose_name_plural': 'Formulários de Análise do Processo',
            },
        ),
        migrations.CreateModel(
